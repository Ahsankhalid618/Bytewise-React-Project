        ...
        <>
                ...
                <div className='flex items-center justify-between gap-10'>
                    ...
                    <div className='w-[58%]'>
                        <div className='w-[90%]'>
                            ...
                            <p className='mt-4 text-[#717171] text-sm font-normal'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sit amet justo ipsum. Sed accumsan quam vitae est varius fringilla. Pellentesque placerat vestibulum lorem sed porta. Nullam mattis tristique iaculis. Nullam pulvinar sit amet risus pretium auctor. Etiam quis massa pulvinar, aliquam quam vitae, tempus sem. Donec elementum pulvinar odio.</p>
                        </div>
                        <button className='primary-btn-medium mt-8'>Learn More</button>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-[#F5F7FA] px-36 py-14'>
                <div className='flex items-center justify-between'>
                    <div className='w-[55%]'>
                        <div>
                            <h1 className='text-4xl text-[#4D4D4D] font-semibold'>Helping a local</h1>
                            <h1 className='text-4xl text-[#4CAF4F] font-semibold'>business reinvent itself</h1>
                        </div>
                        <p className='text-sm mt-2'>We reached here with our hard work and dedication</p>
                    </div>
            ...
            <div className='bg-[#F5F7FA]'>
                <div className='px-36 py-10'>
                    <div className='flex items-start justify-between gap-10'>
                        ...
                        <div className='w-[70%]'>
                            <p className='text-[#717171] text-sm font-medium w-[90%]'>Maecenas dignissim justo eget nulla rutrum molestie. Maecenas lobortis sem dui, vel rutrum risus tincidunt ullamcorper. Proin eu enim metus. Vivamus sed libero ornare, tristique quam in, gravida enim. Nullam ut molestie arcu, at hendrerit elit. Morbi laoreet elit at ligula molestie, nec molestie mi blandit. Suspendisse cursus tellus sed augue ultrices, quis tristique nulla sodales. Suspendisse eget lorem eu turpis vestibulum pretium. Suspendisse potenti. Quisque malesuada enim sapien, vitae placerat ante feugiat eget. Quisque vulputate odio neque, eget efficitur libero condimentum id. Curabitur id nibh id sem dignissim finibus ac sit amet magna.</p>
                            <h4 className='text-[#4CAF4F] font-semibold my-2'>Tim Smith</h4>
                            ...
                            <div className='flex items-center gap-9 my-5'>
                                ...
                                <img src={logo4} alt="" />
                                <img src={logo5} alt="" />
                                <div className='flex items-center gap-2 text-[#4CAF4F] font-semibold'>
