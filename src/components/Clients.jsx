    ...
    return (
        <>
            <div className='my-10 px-36 text-center'>
                <h1 className='text-[#4D4D4D] text-4xl leading-[44px] font-semibold'>Our Clients</h1>
                <p className='text-[#717171] text-base font-normal'>We have been working with some Fortune 500+ clients</p>
